...
_**CVPR 2024** (NeurIPS 2023 Workshop: Attributing Model Behavior at Scale)_  
...
_**NeurIPS 2023 Workshop**: Unifying Representations in Neural Models_
...
_**NeurIPS 2023** (ICLR 2023 Workshop: Neural Fields across Fields)_
...
_**TMLR 2023** (ICML 2023 Workshop: Spurious Correlations, Invariance, and Stability)_
...
_**ICML 2023** (ICLR 2023 Workshop: Neural Fields across Fields)_
...
_**ICML 2023 Workshop**: High-Dimensional Learning Dynamics_
...
_**NeurIPS 2022**_ ([project page](https://subin-kim-cv.github.io/NVP/))
...
_**COLT 2021** (DeepMath 2020 `Oral`)_
...
_**ICLR 2021** `Spotlight` (DeepMath 2020 `Oral`)_ 
...
_**Sparse Neural Network Workshop 2021**_
